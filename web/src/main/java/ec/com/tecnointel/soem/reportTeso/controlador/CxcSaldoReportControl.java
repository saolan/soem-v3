...
@Named
@ViewScoped
public class CxcSaldoReportControl extends CxcModuloControl implements Serializable {

	private static final long serialVersionUID = -5517828830079751311L;
	
	@Override
	public void descargar() {

//		Nombre del reporte en JasperReport
		String nombreReporte = "cxcSaldos";
