...
a persistence unit "soemPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "soem/pom.xml":
...
artifacts ("soem-ejb.jar" and "soem-web.war") are already built. You can build
